...
// Also add click listener for quick toggle
    ...
    private void openCamera() {
        Intent i = new Intent(ImageNoteActivity.this, CameraActivity.class);
    ...
    public void registerListeners(){
        ...
        voiceicon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(ImageNoteActivity.this, android.Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {

                    // --- Case 1: Permission is denied, but not permanently. ---
                    if (ActivityCompat.shouldShowRequestPermissionRationale(ImageNoteActivity.this, android.Manifest.permission.RECORD_AUDIO)) {
                        // Show an explanation to the user via a dialog.
                        new AlertDialog.Builder(ImageNoteActivity.this)
                                ...
                                .setPositiveButton(R.string.grant_text, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        ActivityCompat.requestPermissions(ImageNoteActivity.this, new String[]{android.Manifest.permission.RECORD_AUDIO}, PERMISSION_REQUEST_CODE);
                                    }
                                })
                    ...
                    MediaPlayer mp = MediaPlayer.create(ImageNoteActivity.this, R.raw.googleassistant);
                    if (mp != null) {
                        mp.start();
            ...
            try {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        // 3. Inform the user
                        Toast.makeText(ImageNoteActivity.this, "Note translated to " + targetLanguage, Toast.LENGTH_SHORT).show();
                    });
                    ...
                    runOnUiThread(() -> {
                        if (correctionProgressBar != null) correctionProgressBar.setVisibility(View.GONE);
                        Toast.makeText(ImageNoteActivity.this, "Error: Translation failed.", Toast.LENGTH_SHORT).show();
                    });
                }
            } catch (Exception e) {
                ...
                runOnUiThread(() -> {
                    if (correctionProgressBar != null) correctionProgressBar.setVisibility(View.GONE);
                    Toast.makeText(ImageNoteActivity.this, "An error occurred.", Toast.LENGTH_SHORT).show();
                });
            }
        });
    }
    ...
    /**
     * Takes the current text from the ImageNoteActivity, sends it to the Gemini API for summarization,
            ...
            try {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        Toast.makeText(ImageNoteActivity.this, "Summary appended!", Toast.LENGTH_SHORT).show();
                    });
                    ...
                    runOnUiThread(() -> {
                        correctionProgressBar.setVisibility(View.GONE);
                        Toast.makeText(ImageNoteActivity.this, "Error: Could not get summary.", Toast.LENGTH_SHORT).show();
                    });
                }
            } catch (Exception e) {
    ...
    /**
     * Takes the current text from the ImageNoteActivity, sends it to the Gemini API for correction,
            ...
            try {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        isNoteModified = true; // Mark the note as modified
                        correctionProgressBar.setVisibility(View.GONE);
                        Toast.makeText(ImageNoteActivity.this, "Spellings corrected!", Toast.LENGTH_SHORT).show();
                    });
                    ...
                    runOnUiThread(() -> {
                        correctionProgressBar.setVisibility(View.GONE);
                        Toast.makeText(ImageNoteActivity.this, "Error: Could not correct text.", Toast.LENGTH_SHORT).show();
                    });
                }
            } catch (Exception e) {
    ...
    public void init(){
        setContentView(R.layout.imagenote_activity);

package com.noteaiapp.keyboardai.operationactivity.trashfiles;
...
import com.noteaiapp.keyboardai.data.NotesDbHelper;
...
public class NotesRepositoryTrash {

    private final NotesDbHelperTrash dbHelper;
    private final Context context;

    public NotesRepositoryTrash(Context context) {
        this.context = context;
        dbHelper = new NotesDbHelperTrash(context);
    }

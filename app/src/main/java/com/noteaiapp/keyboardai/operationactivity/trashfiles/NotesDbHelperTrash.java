...
public class NotesDbHelperTrash extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "notes.dbtrash";
    ...
    public NotesDbHelperTrash(Context context) {
